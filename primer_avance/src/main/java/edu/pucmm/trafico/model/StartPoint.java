    ...
    public double[] getExitCoordinates(Direction direction) {
        return switch (this) {
            case NORTH -> switch (direction) {
                ...
                case LEFT -> new double[]{10, 275};     // Izquierda hacia el Oeste, carril derecho
                case RIGHT -> new double[]{790, 315};   // Derecha hacia el Este, carril derecho
            ...
            case SOUTH -> switch (direction) {
                ...
                case LEFT -> new double[]{790, 315};     // Izquierda hacia el Este, carril derecho
                case RIGHT -> new double[]{10, 275};     // Derecha hacia el Oeste, carril derecho
